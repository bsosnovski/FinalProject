...
For our analysis, we are interest in the tweets send by people other than the candidates themselves. So we exclude the tweets whose user name are the candidates.
